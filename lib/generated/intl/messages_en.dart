...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(grade) => "Grade: ${grade}";

  static m2(fileName) => "Downloading ${fileName}…";

  static m3(count) => "${count} items in total";

  static m4(timeToWait) => "Too many requests. Try again in ${timeToWait}.";

  static m5(published, author) => "published on ${published} by ${author}";

  static m6(author) => "by ${author}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "assignment_dashboardCard_header" : MessageLookupByLibrary.simpleMessage("Open Assignments\nin the next week"),
    "assignment_detailsScreen_mySubmission" : MessageLookupByLibrary.simpleMessage("My submission"),
    "assignment_submissionScreen_gradeTitle" : m1,
    ...
    "login_form_errorAuth" : MessageLookupByLibrary.simpleMessage("Authentication failed."),
    "login_form_errorNoConnection" : MessageLookupByLibrary.simpleMessage("No connection to the server."),
    "login_form_errorRateLimit" : m4,
    ...
    "news_articlePreview_subtitle" : m5,
    "news_authorView" : m6,
